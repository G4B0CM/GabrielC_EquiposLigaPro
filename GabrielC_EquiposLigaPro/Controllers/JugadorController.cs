...
namespace GabrielC_EquiposLigaPro.Controllers
{
    public class JugadorController : Controller
    {
        ...
        public JugadorController(GabrielC_EquiposLigaProContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,Posicion,Edad,IDEquipo,IDEstadio")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,Posicion,Edad,IDEquipo,IDEstadio")] Jugador jugador)
        {
            if (id != jugador.ID)
            {
                return NotFound();
